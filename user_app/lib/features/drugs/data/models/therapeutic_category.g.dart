...
_TherapeuticCategory _$TherapeuticCategoryFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$TherapeuticCategoryToJson(
  _TherapeuticCategory instance,
) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
...
_CreateTherapeuticCategoryRequest _$CreateTherapeuticCategoryRequestFromJson(
...
Map<String, dynamic> _$CreateTherapeuticCategoryRequestToJson(
  _CreateTherapeuticCategoryRequest instance,
) => <String, dynamic>{
  'name': instance.name,
