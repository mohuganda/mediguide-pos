...
async function listResource<T>(
  ...
  const result = await backend().request<ListResult<T>>(path, {
    query: params,
  });
...
async function tableResource<T>(
  ...
  const result = await backend().request<ListResult<Record<string, unknown>>>(
    path,
    {
      query: {
        page: params.page,
  ...
  return {
    ...
    totalPages:
      result.total_pages ?? Math.ceil(result.total_items / result.per_page),
  };
}
...
export const healthFacilitiesService = {
  listFacilityTable<T extends HealthFacilitiesResponse>(
    params: TableListParams,
  ) {
    return tableResource<T>(
      "/api/v2/facilities",
      params,
      (raw) =>
        ({
          ...
          expand: {
            facility_level: related(
              raw.facility_level_id,
              raw.facility_level_name,
              raw.facility_level_code,
            ),
            authority: related(
              raw.authority_id,
              raw.authority_name,
            ...
            ownership_type: related(
              raw.ownership_type_id,
              raw.ownership_type_name,
              raw.ownership_type_code,
            ),
            ...
            health_sub_region: related(
              raw.health_sub_region_id,
              raw.health_sub_region_name,
            ),
            health_sub_district: related(
              raw.health_sub_district_id,
              raw.health_sub_district_name,
            ),
          },
        }) as T,
      facilityFilters(params.filters),
    );
  },
  ...
  listHealthSubRegions(params: TableListParams) {
    return tableResource<HealthSubRegionsWithRegion>(
  ...
  listDistricts(params: TableListParams) {
    return tableResource<DistrictsWithExpanded>(
      "/api/v2/districts",
      params,
      (raw) => ({
        ...
        expand: {
          ...
          health_sub_region: related(
            raw.health_sub_region_id,
            raw.health_sub_region_name,
          )! as HealthSubRegionsResponse,
        },
      }),
    );
  },
  listHealthSubDistricts(params: TableListParams) {
    return tableResource<HealthSubDistrictsResponse>(
      "/api/v2/health-sub-districts",
      params,
    );
  },
  listCounties(params: TableListParams) {
    return tableResource<CountiesWithDistrict>(
      "/api/v2/counties",
      params,
      (raw) => ({
  ...
  listSubcounties(params: TableListParams) {
    return tableResource<SubcountiesWithExpanded>(
      "/api/v2/subcounties",
      params,
      (raw) => ({
  ...
  listParishes(params: TableListParams) {
    return tableResource<ParishesWithSubcounty>(
      "/api/v2/parishes",
      params,
      (raw) => ({
      ...
      (raw) => ({
        ...
        expand: {
          ownership_type: related(
            raw.ownership_type_id,
            raw.ownership_type_name,
          )! as OwnershipTypesResponse,
        },
      }),
    );
  },
  listFacilities(params: FacilityListParams = {}) {
    return backend().request<ListResult<HealthFacilitiesResponse>>(
      "/api/v2/facilities",
      {
  ...
  async getFacility(id: string) {
    const result = await backend().request<ItemResult<Record<string, unknown>>>(
  ...
  updateFacility(id: string, data: Record<string, unknown>) {
    return backend().request<HealthFacilitiesResponse>(
      `/api/v2/facilities/${id}`,
      {
        method: "PATCH",
        body: JSON.stringify(data),
  ...
  deleteFacility(id: string) {
    return backend().request<void>(`/api/v2/facilities/${id}`, {
      method: "DELETE",
    });
  },
  createRegion(data: Record<string, unknown>) {
    return backend().request<RegionsResponse>("/api/v2/regions", {
      method: "POST",
      body: JSON.stringify(data),
    });
  },
  updateRegion(id: string, data: Record<string, unknown>) {
    return backend().request<RegionsResponse>(`/api/v2/regions/${id}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    });
  },
  deleteRegion(id: string) {
    return backend().request<void>(`/api/v2/regions/${id}`, {
      method: "DELETE",
    });
  },
  createHealthSubRegion(data: Record<string, unknown>) {
    return backend().request<HealthSubRegionsResponse>(
      "/api/v2/health-sub-regions",
  ...
  updateHealthSubRegion(id: string, data: Record<string, unknown>) {
    return backend().request<HealthSubRegionsResponse>(
      `/api/v2/health-sub-regions/${id}`,
      { method: "PATCH", body: JSON.stringify(data) },
    );
  },
  deleteHealthSubRegion(id: string) {
    return backend().request<void>(`/api/v2/health-sub-regions/${id}`, {
      method: "DELETE",
    });
  },
  createDistrict(data: Record<string, unknown>) {
    return backend().request<DistrictsResponse>("/api/v2/districts", {
      method: "POST",
      body: JSON.stringify(data),
    });
  },
  updateDistrict(id: string, data: Record<string, unknown>) {
    return backend().request<DistrictsResponse>(`/api/v2/districts/${id}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    });
  },
  deleteDistrict(id: string) {
    return backend().request<void>(`/api/v2/districts/${id}`, {
      method: "DELETE",
    });
  },
  createHealthSubDistrict(data: Record<string, unknown>) {
    return backend().request<HealthSubDistrictsResponse>(
      "/api/v2/health-sub-districts",
      { method: "POST", body: JSON.stringify(data) },
    );
  },
  updateHealthSubDistrict(id: string, data: Record<string, unknown>) {
    return backend().request<HealthSubDistrictsResponse>(
      `/api/v2/health-sub-districts/${id}`,
      { method: "PATCH", body: JSON.stringify(data) },
    );
  },
  deleteHealthSubDistrict(id: string) {
    return backend().request<void>(`/api/v2/health-sub-districts/${id}`, {
      method: "DELETE",
    });
  },
  createCounty(data: Record<string, unknown>) {
    return backend().request<CountiesResponse>("/api/v2/counties", {
      method: "POST",
      body: JSON.stringify(data),
    });
  },
  updateCounty(id: string, data: Record<string, unknown>) {
    return backend().request<CountiesResponse>(`/api/v2/counties/${id}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    });
  },
  deleteCounty(id: string) {
    return backend().request<void>(`/api/v2/counties/${id}`, {
      method: "DELETE",
    });
  },
  createSubcounty(data: Record<string, unknown>) {
    return backend().request<SubcountiesResponse>("/api/v2/subcounties", {
      method: "POST",
      body: JSON.stringify(data),
    });
  },
  updateSubcounty(id: string, data: Record<string, unknown>) {
    return backend().request<SubcountiesResponse>(`/api/v2/subcounties/${id}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    });
  },
  deleteSubcounty(id: string) {
    return backend().request<void>(`/api/v2/subcounties/${id}`, {
      method: "DELETE",
    });
  },
  createParish(data: Record<string, unknown>) {
    return backend().request<ParishesResponse>("/api/v2/parishes", {
      method: "POST",
      body: JSON.stringify(data),
    });
  },
  updateParish(id: string, data: Record<string, unknown>) {
    return backend().request<ParishesResponse>(`/api/v2/parishes/${id}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    });
  },
  deleteParish(id: string) {
    return backend().request<void>(`/api/v2/parishes/${id}`, {
      method: "DELETE",
    });
  },
  createFacilityLevel(data: Record<string, unknown>) {
    return backend().request<FacilityLevelsResponse>(
      "/api/v2/facility-levels",
      { method: "POST", body: JSON.stringify(data) },
    );
  },
  updateFacilityLevel(id: string, data: Record<string, unknown>) {
    return backend().request<FacilityLevelsResponse>(
      `/api/v2/facility-levels/${id}`,
      { method: "PATCH", body: JSON.stringify(data) },
    );
  },
  deleteFacilityLevel(id: string) {
    return backend().request<void>(`/api/v2/facility-levels/${id}`, {
      method: "DELETE",
    });
  },
  createOwnershipType(data: Record<string, unknown>) {
    return backend().request<OwnershipTypesResponse>(
      "/api/v2/ownership-types",
      { method: "POST", body: JSON.stringify(data) },
    );
  },
  updateOwnershipType(id: string, data: Record<string, unknown>) {
    return backend().request<OwnershipTypesResponse>(
      `/api/v2/ownership-types/${id}`,
      { method: "PATCH", body: JSON.stringify(data) },
    );
  },
  deleteOwnershipType(id: string) {
    return backend().request<void>(`/api/v2/ownership-types/${id}`, {
      method: "DELETE",
    });
  },
  createAuthority(data: Record<string, unknown>) {
    return backend().request<AuthoritiesResponse>("/api/v2/authorities", {
      method: "POST",
      body: JSON.stringify(data),
    });
  },
  updateAuthority(id: string, data: Record<string, unknown>) {
    return backend().request<AuthoritiesResponse>(`/api/v2/authorities/${id}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    });
  },
  deleteAuthority(id: string) {
    return backend().request<void>(`/api/v2/authorities/${id}`, {
      method: "DELETE",
    });
  },
  regions() {
  ...
  districts(regionId?: string) {
    return listResource<DistrictsResponse>("/api/v2/districts", {
      per_page: 200,
      region_id: regionId,
    });
  },
  counties(districtId?: string) {
    return listResource<CountiesResponse>("/api/v2/counties", {
      per_page: 200,
      district_id: districtId,
    });
  },
  subcounties(districtId?: string, countyId?: string) {
    return listResource<SubcountiesResponse>("/api/v2/subcounties", {
      per_page: 200,
      district_id: districtId,
      county_id: countyId,
    });
  ...
  parishes(subcountyId?: string) {
    return listResource<ParishesResponse>("/api/v2/parishes", {
      per_page: 200,
      subcounty_id: subcountyId,
    });
  },
  healthSubRegions(regionId?: string) {
    return listResource<HealthSubRegionsResponse>(
      "/api/v2/health-sub-regions",
      { per_page: 200, region_id: regionId },
    );
  },
  healthSubDistricts(districtId?: string) {
    return listResource<HealthSubDistrictsResponse>(
      "/api/v2/health-sub-districts",
      { per_page: 200, district_id: districtId },
    );
  },
  facilityLevels() {
    return listResource<FacilityLevelsResponse>("/api/v2/facility-levels", {
      per_page: 200,
    });
  },
  ownershipTypes() {
    return listResource<OwnershipTypesResponse>("/api/v2/ownership-types", {
      per_page: 200,
    });
  },
  authorities(ownershipTypeId?: string) {
    return listResource<AuthoritiesResponse>("/api/v2/authorities", {
      per_page: 200,
...
const relationOptions =
  ...
  (search: string, pageSize: number) =>
    listResource<T>(path, { search, per_page: pageSize }) as Promise<
...
export const facilityRelationOptions = {
  regions: {
    key: "regions",
    loadOptions: relationOptions<RegionsResponse>("/api/v2/regions"),
  },
  healthSubRegions: {
    key: "health-sub-regions",
    loadOptions: relationOptions<HealthSubRegionsResponse>(
      "/api/v2/health-sub-regions",
    ),
  },
  districts: {
    key: "districts",
    loadOptions: relationOptions<DistrictsResponse>("/api/v2/districts"),
  },
  healthSubDistricts: {
    key: "health-sub-districts",
    loadOptions: relationOptions<HealthSubDistrictsResponse>(
      "/api/v2/health-sub-districts",
    ),
  },
  counties: {
    key: "counties",
    loadOptions: relationOptions<CountiesResponse>("/api/v2/counties"),
  },
  subcounties: {
    key: "subcounties",
    loadOptions: relationOptions<SubcountiesResponse>("/api/v2/subcounties"),
  },
  parishes: {
    key: "parishes",
    loadOptions: relationOptions<ParishesResponse>("/api/v2/parishes"),
  },
  facilityLevels: {
    key: "facility-levels",
    loadOptions: relationOptions<FacilityLevelsResponse>(
      "/api/v2/facility-levels",
    ),
  },
  authorities: {
    key: "authorities",
    loadOptions: relationOptions<AuthoritiesResponse>("/api/v2/authorities"),
  },
  ownershipTypes: {
    key: "ownership-types",
    loadOptions: relationOptions<OwnershipTypesResponse>(
      "/api/v2/ownership-types",
    ),
  },
};
