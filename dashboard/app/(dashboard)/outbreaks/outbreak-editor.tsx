      ...
      <Card>
        ...
        <CardContent className="grid gap-4 md:grid-cols-2">
          ...
          <Field
            ...
            onChange={(value) => field("disease_type", value)}
          />
          <Field
        ...
        <>
            ...
            <CardContent className="space-y-3">
              <div className="grid gap-2 md:grid-cols-2">
                ...
                {resourceDraft.resource_type === "guideline" ? (
                  <select
                    aria-label="Published guideline"
                  ...
                  <select
                    aria-label="Published situation report"
                    className="h-10 rounded-md border bg-background px-3"
                    value={resourceDraft.url}
                    onChange={(event) =>
                      setResourceDraft((current) => ({
                  ...
                  <Input
                    aria-label="Managed resource URL"
                    disabled
          ...
          <Card>
            ...
            <CardContent className="flex flex-wrap gap-2">
              ...
              <Button
                variant="outline"
                disabled={saving || item.status !== "pending_review"}
